...
public class Montana extends Tierra {
	...
	***************/
    public boolean accion(Jugador p){
        ...
        if(p.getEnergia() == 0){
            flag = false;
            System.out.println("No puedes cruzar la montana no tienes energia. :(");
            System.out.println(" ");
            return flag;
            ...
            else if (p.getEnergia() >= 3){
            p.setEnergia(p.getEnergia() -3);
            System.out.println("puedes cruzar normalmente bienvenido a la montana ");
            System.out.println(" ");
            }
        }
        if(this.bueno != null){
